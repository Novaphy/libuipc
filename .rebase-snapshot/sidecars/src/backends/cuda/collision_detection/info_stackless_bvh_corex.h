...
{
template <>
struct force_trivially_destructible<uipc::backend::cuda::InfoStacklessBVH::Node>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_constructible<uipc::backend::cuda::InfoStacklessBVH::Node>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_constructible<uipc::backend::cuda::InfoStacklessBVH::Node>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_assignable<uipc::backend::cuda::InfoStacklessBVH::Node>
{
    constexpr static bool value = true;
};
}  // namespace muda
