...
{
template <>
struct force_trivially_destructible<uipc::backend::cuda::detail::LinearBVHMortonIndex>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_constructible<uipc::backend::cuda::detail::LinearBVHMortonIndex>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_constructible<uipc::backend::cuda::detail::LinearBVHMortonIndex>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_assignable<uipc::backend::cuda::detail::LinearBVHMortonIndex>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_destructible<uipc::backend::cuda::LinearBVHNode>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_constructible<uipc::backend::cuda::LinearBVHNode>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_constructible<uipc::backend::cuda::LinearBVHNode>
{
    constexpr static bool value = true;
};

template <>
struct force_trivially_copy_assignable<uipc::backend::cuda::LinearBVHNode>
{
    constexpr static bool value = true;
};
}  // namespace muda
