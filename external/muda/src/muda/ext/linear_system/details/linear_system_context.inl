    ...
    , m_converter(m_handles)
{
    ...
    // Delay the large temp-buffer allocation on CoreX until first use. Eagerly
    // grabbing the default 256MB workspace during SimSystem construction can
    // stall world.init before any actual linear solve happens.
#else
