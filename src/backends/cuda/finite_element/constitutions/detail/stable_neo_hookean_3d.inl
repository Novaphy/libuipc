...
__host__ __device__ void ddEddVecF(Eigen::Matrix<T, 9, 9>& R, const T& mu, const T& lambda, const Eigen::Matrix<T, 3, 3>& F)
{
    ...
    g1.template block<3, 1>(0, 0) = 2 * F.col(0);
    g1.template block<3, 1>(3, 0) = 2 * F.col(1);
    g1.template block<3, 1>(6, 0) = 2 * F.col(2);
    Eigen::Matrix<T, 9, 1> gJ;
    gJ.template block<3, 1>(0, 0) = F.col(1).cross(F.col(2));
    gJ.template block<3, 1>(3, 0) = F.col(2).cross(F.col(0));
    gJ.template block<3, 1>(6, 0) = F.col(0).cross(F.col(1));
    ...
    HJ.template block<3, 3>(0, 0) = Eigen::Matrix<T, 3, 3>::Zero();
    HJ.template block<3, 3>(0, 3) = -f2hat;
    HJ.template block<3, 3>(0, 6) = f1hat;
    HJ.template block<3, 3>(3, 0) = f2hat;
    HJ.template block<3, 3>(3, 3) = Eigen::Matrix<T, 3, 3>::Zero();
    HJ.template block<3, 3>(3, 6) = -f0hat;
    HJ.template block<3, 3>(6, 0) = -f1hat;
    HJ.template block<3, 3>(6, 3) = f0hat;
    HJ.template block<3, 3>(6, 6) = Eigen::Matrix<T, 3, 3>::Zero();
