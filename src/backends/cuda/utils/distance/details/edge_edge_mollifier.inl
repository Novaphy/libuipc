...
{
template <typename T>
MUDA_HOST MUDA_DEVICE void g_EECN2(
...
template <typename T>
MUDA_HOST MUDA_DEVICE void H_EECN2(
...
template <typename T>
MUDA_HOST MUDA_DEVICE void EEM(T input, T eps_x, T& e)
{
...
template <typename T>
MUDA_HOST MUDA_DEVICE void g_EEM(T input, T eps_x, T& g)
{
...
template <typename T>
MUDA_HOST MUDA_DEVICE void H_EEM(T input, T eps_x, T& H)
{
    H = -2.0 / (eps_x * eps_x);
}
}  // namespace uipc::backend::cuda::distance::details
